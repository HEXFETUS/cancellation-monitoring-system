...
export default function ReasonForDenyPage() {
    ...
    return (
        <div className="space-y-6">
            {/* ─────────────── Decorative Header ─────────────── */}
            <div className="group relative overflow-hidden rounded-3xl border border-white/30 bg-linear-to-br from-white/40 via-white/20 to-white/5 p-6 shadow-xl backdrop-blur-xl transition-all duration-300 sm:p-8 hover:shadow-2xl">
                <div className="pointer-events-none absolute -right-16 -top-16 h-48 w-48 rounded-full bg-linear-to-br from-teal/15 to-teal-light/5 blur-3xl transition-all duration-700 group-hover:scale-110" />
                <div className="pointer-events-none absolute -bottom-12 -left-12 h-36 w-36 rounded-full bg-linear-to-br from-teal-light/10 to-warm/20 blur-3xl transition-all duration-700 group-hover:scale-110" />
                ...
                <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-4">
                        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-teal via-teal-light to-teal text-white shadow-lg shadow-teal/30 ring-1 ring-white/20 transition-all duration-300 group-hover:shadow-teal/40 group-hover:scale-105">
            ...
            {message && (
                <div
                    className={`animate-[slideDown_0.4s_cubic-bezier(0.16,1,0.3,1)] rounded-2xl border px-5 py-3.5 text-sm font-medium shadow-lg backdrop-blur-md ${
                        message.type === "error"
                            ? "border-rose/30 bg-linear-to-r from-rose/10 to-rose/5 text-rose-dark ring-1 ring-rose/20"
                            : "border-emerald-200/40 bg-linear-to-r from-emerald-50/80 to-emerald-50/40 text-emerald-700 ring-1 ring-emerald-200/30"
                    }`}
                >
            ...
            <div className="group relative overflow-hidden rounded-3xl border border-white/30 bg-linear-to-br from-white/40 via-white/20 to-white/5 p-6 shadow-xl backdrop-blur-xl transition-all duration-300 sm:p-8 hover:shadow-2xl">
                ...
                <div className="relative">
                    <div className="mb-6 flex items-center gap-2.5">
                        <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-linear-to-br from-teal/10 to-teal-light/10 ring-1 ring-teal/20">
