...
import { fetchStatusLogs } from "../services";
                    ...
                    <table className="min-w-full text-sm">
                        <thead>
                            <tr className="border-b border-gray-100 bg-gray-50/80">
                                ...
                                <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-500">New Status</th>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {filteredLogs.length === 0 ? (
                                ...
                                paginatedLogs.map((log) => {
                                    const oldStatus = log.old_status || "N/A";
                                    const newStatus = log.new_status || "N/A";
                                    return (
