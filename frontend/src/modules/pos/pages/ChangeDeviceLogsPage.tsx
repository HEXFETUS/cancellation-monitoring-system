...
export default function ChangeDeviceLogsPage() {
    ...
    return (
        <div className="flex flex-col gap-6">
            {/* HEADER */}
            <div>
                <h1 className="text-2xl font-bold text-gray-800">Change Device Logs</h1>
                <p className="mt-1 text-sm text-gray-500">
                    History of all device reassignments between booths.
                </p>
            </div>
